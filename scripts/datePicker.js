...
function cal_gen_date1 (dt_datetime) {
	...
	// pasquali.sandro@gmail.com
	// wanted yyyy-mm-dd
	
	return (dt_datetime.getFullYear() + '-' + (dt_datetime.getMonth() < 9 ? '0' : '') + (dt_datetime.getMonth() + 1) + '-' + (dt_datetime.getDate() < 10 ? '0' : '') + dt_datetime.getDate());
...
function cal_prs_tsmp1 (str_datetime) {
	...
	if (!str_datetime)
	  {
	  	// modified to set current time to 00:00:00
